$(document).ready(function(){
    ...
    responsive: [
      ...
      },
      {
        ...
        settings: {
          ...
          infinite: true,
          initialSlide: 1,
          nextArrow: $('.stories__container--small .stories__next-link'),
          prevArrow: $('.stories__container--small .stories__prev-link'),
          slidesToShow: 1,
          slidesToScroll: 1,
          variableWidth: true
        }
  ...
  $('.stories__container--large').slick({
    ...
    autoplay: false,
    infinite: true,
    nextArrow: $('.stories__container--large .stories__next-link'),
    prevArrow: $('.stories__container--large .stories__prev-link'),
    slidesToShow: 2,
    slidesToScroll: 2,
    variableWidth: true,
    responsive: [
